 ...
 *
 * XBMC.GetInfoLabel
 * For a list of commands, see http://wiki.xbmc.org/index.php?title=InfoLabels
 */
...
*/
	...
	function Model() {
        ...
        function _init() {
            me.loaded(true);
            me.ui.loading(false);
            //me.player.startAutoRefresh();
            xbmc.monitorWeather(function(weather) {
                me.weather.temperature(weather.temperature);
                me.weather.conditions(weather.conditions);
            });
            //me.weather.startAutoRefreshstartAutoRefresh();
        ...
        this.player = new function() {
            ...
            this.startAutoRefresh = function() {
                ...
                var onActivePlayerChanged = function(player) {
                    ...
                    self.players[player.type].active(player.active);
                };
                var onPlayerDetailsUpdated = function(player) {
                    //console.log('Player details updated');

                    me.player.current.title(player.title);
                    me.player.current.time(player.time);
                    me.player.current.duration(player.duration);
                    me.player.current.year(player.year);
                    me.player.current.paused(player.paused);

                    if (player.type == 'audio') {
                        me.player.current.artist(player.artist);
                        me.player.current.album(player.album);
                        me.player.current.genre(player.genre);
                    } else if (player.type == 'video') {
                        me.player.current.artist(player.studio);
                        me.player.current.album(player.resolution);
                        me.player.current.genre(player.rating);
                    }
                };
